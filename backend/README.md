...
## Project Structure
    ...
    ├── pg_paddle_selector_36941  # Django project configurations
...
1. Clone this repo and `cd pg_paddle_selector_36941`
...
2. Clone this repo and `cd pg_paddle_selector_36941`
